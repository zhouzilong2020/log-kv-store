...
class my_log {
    ...
    private:
        ...
        int write_interval;     // specifies the time interval that a disk write will be triggered
        ...
        int timer_trigger();    // this function will trigger the disk write periodically, even if the log capacity is not reached
